function results = Vibration(Version,resolution)
...
lp(2)                   = le(2)/1;                                % size of particle in Y direction
...
%         nfbcx,nfbcy,fbcx,fbcy,F_sp,V_spo,dt);
%     
        [v_ssp,x_sp,d_sp,F_sp,V_sp,s_sp,p_sp] = BSMPM_solvertest(CModel,CModel_parameter,...
        nodeCount,spCount,cellCount,x_sp,x_spo,d_sp,le,NN,LOC,b_sp,V_sp,ptraction_sp,v_ssp,s_sp,m_sp,p_sp,...
        nfbcx,nfbcy,fbcx,fbcy,F_sp,V_spo,dt);
...
%         [v_ssp,x_sp,d_sp,F_sp,V_sp,s_sp,p_sp] = MLS_BSMPM_solvertest(CModel,CModel_parameter,...
%         nodeCount,spCount,cellCount,x_sp,x_spo,d_sp,le,NN,LOCC,b_sp,V_sp,ptraction_sp,v_ssp,s_sp,m_sp,p_sp,...
%         F_sp,V_spo,dt,GaussCount,x_gauss,y_gauss,omega_gauss);
    
        [v_ssp,x_sp,d_sp,F_sp,V_sp,s_sp,p_sp] = MLS_BSMPM_solvertest1(CModel,CModel_parameter,...
        nodeCount,spCount,cellCount,x_sp,x_spo,d_sp,le,NN,LOCC,b_sp,V_sp,ptraction_sp,v_ssp,s_sp,m_sp,p_sp,...
        F_sp,V_spo,dt,GaussCount,x_gauss,y_gauss,omega_gauss);
     end
