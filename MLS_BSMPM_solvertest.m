function[v_ssp,x_sp,d_sp,F_sp,V_sp,s_sp,p_sp] = MLS_BSMPM_solvertest(CModel,CModel_parameter,...
...
%      % Build stress tensor
    ...
    if position_Gauss(1)>2*le(1) && position_Gauss(1)<1+2*le(1) && position_Gauss(2)<2*le(2) && position_Gauss(2)>le(2)
     % Density
