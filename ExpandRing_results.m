...
hold on
% x2 = [0.006 0.06]; y2 = [0.0001 0.01];
x2 = [0.006 0.06]; y2 = [0.1 10];
...
hold on
% x2 = [0.006 0.06]; y2 = [1 10];
x2 = [0.006 0.06]; y2 = [100 1000];
plot(x2,y2,'--k','linewidth',2);
hold on
% scatter(dcell,CPDI_stress,100,'g','filled')
% hold on
...
legend('CPDI','CPLS','1st order','Location','northwest')
xlabel('cell size (m)')
ylabel('RMS')
set(gca,'fontsize', 15)
